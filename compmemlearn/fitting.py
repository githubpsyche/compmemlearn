...
__all__ = ['murdock_data_likelihood', 'murdock_objective_function', 'lb', 'lohnas_data_likelihood',
           'lohnas_objective_function', 'lb', 'semantic_data_likelihood', 'semantic_objective_function', 'lb',
           'generate_objective_function', 'model_weights', 'apply_and_concatenate']
...
def generate_objective_function(
    ...
    if language_model is None:
        ...
        # we generate similiarity matrix for each list length
        similarities = []
        ...
        return semantic_objective_function(
            List(trials), List(list_lengths), List(similarities), model_class, fixed_parameters, free_parameters)
