...
__all__ = ['familiarity_weighting', 'cmr_spec', 'Classic_CMR', 'familiarity_weighting', 'cmr_spec', 'Classic_CMR_Alpha',
           'Dual_ICMR', 'dual_icmr_spec', 'Dual_Dot_ICMR', 'dual_dot_icmr_spec', 'Base_CMR', 'base_cmr_spec',
           'Single_ICMR', 'single_icmr_spec', 'icmr_spec', 'Dual_Instance_CMR', 'expcmr_spec', 'Exp_ICMR', 'Lrn_ICMR',
           'icmr_de_spec', 'ICMR_DE', 'icmr_spec', 'Instance_CMR', 'icmr_spec', 'Instance_CMR_Alpha', 'ncmr_spec',
           'noise', 'Noisy_CMR', 'trcmr_spec', 'Trace_Reinstatement_CMR']
