...
__all__ = ['familiarity_weighting', 'cmr_spec', 'Classic_CMR', 'familiarity_weighting', 'cmr_spec', 'Classic_CMR_Alpha',
           'Base_CMR', 'lb', 'base_cmr_spec', 'Single_ICMR', 'lb', 'single_icmr_spec', 'icmr_spec', 'Dual_Instance_CMR',
           'expcmr_spec', 'Exp_ICMR', 'Lrn_ICMR', 'icmr_de_spec', 'ICMR_DE', 'icmr_spec', 'Instance_CMR', 'icmr_spec',
           'Instance_CMR_Alpha', 'ncmr_spec', 'noise', 'Noisy_CMR', 'trcmr_spec', 'Trace_Reinstatement_CMR']
