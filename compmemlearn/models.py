# AUTOGENERATED! DO NOT EDIT! File to edit: library/Old_Instance_CMR/02_Instance_CMR.ipynb (unless otherwise specified).

__all__ = ['cmr_spec', 'Classic_CMR', 'icmr_spec', 'Instance_CMR', 'cmr_spec', 'Classic_CMR', 'icmr_spec',
           'Instance_CMR']
