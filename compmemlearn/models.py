...
__all__ = ['icmr_spec', 'Instance_CMR', 'cmr_spec', 'Classic_CMR', 'Exp_ICMR', 'Lrn_ICMR', 'icmr_de_spec', 'ICMR_DE',
           'icmr_spec', 'Instance_CMR', 'ncmr_spec', 'noise', 'Noisy_CMR', 'trcmr_spec', 'Trace_Reinstatement_CMR']
