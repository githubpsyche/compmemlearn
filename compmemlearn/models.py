...
__all__ = ['familiarity_weighting', 'cmr_spec', 'Classic_CMR', 'expcmr_spec', 'Exp_ICMR', 'Lrn_ICMR', 'icmr_de_spec',
           'ICMR_DE', 'icmr_spec', 'Instance_CMR', 'ncmr_spec', 'noise', 'Noisy_CMR', 'trcmr_spec',
