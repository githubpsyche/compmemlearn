# AUTOGENERATED! DO NOT EDIT! File to edit: library/analyses/Serial_Position_Effect.ipynb (unless otherwise specified).

__all__ = ['alternative_contiguity', 'fast_sem_crp', 'plot_sem_crp', 'fast_csp', 'plot_csp', 'fast_crp',
           'flex_mixed_crp', 'plot_crp', 'fast_mixed_crp', 'flex_mixed_crp', 'plot_flex_crp', 'randomize_dataset',
           'indices_of_repeated_items', 'alternative_contiguity_test', 'alternative_contiguity_control',
           'sim_alternative_contiguity_test', 'fast_pfr', 'flex_mixed_pfr', 'plot_pfr', 'fast_rpl', 'plot_rpl', 'rpl',
           'recall_by_all_study_positions', 'fast_spc', 'flex_mixed_spc', 'plot_spc']
...
def plot_crp(data, trial_query, contrast_name=None, labels=None, axis=None, max_lag=5):
    ...
    sns.lineplot(ax=axis, data=result, x='lag', y='prob', err_style='bars', hue=contrast_name,
        style="positive", dashes=False, legend=False)
