...
__all__ = ['fast_csp', 'plot_csp', 'fast_crp', 'plot_lag_crp', 'randomize_dataset', 'indices_of_repeated_items',
           'alternative_contiguity_test', 'alternative_contiguity_control', 'sim_alternative_contiguity_test',
           'fast_pfr', 'plot_pfr', 'fast_rpl', 'rpl', 'fast_spc', 'plot_spc', 'fast_csp', 'plot_csp', 'fast_crp',
           'plot_lag_crp', 'randomize_dataset', 'indices_of_repeated_items', 'alternative_contiguity_test',
           'alternative_contiguity_control', 'sim_alternative_contiguity_test', 'fast_pfr', 'plot_pfr', 'fast_rpl',
           'rpl', 'fast_spc', 'plot_spc']
