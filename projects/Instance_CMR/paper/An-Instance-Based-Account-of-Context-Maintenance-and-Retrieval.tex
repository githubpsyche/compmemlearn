...
\includegraphics{./individual_murdock1970.pdf}
...
{\centering \includegraphics{./overall_murdock1970.pdf}
...
\includegraphics{./individual_murdock1962.pdf}
...
\includegraphics{./cmr_summary_murdock1962.pdf}
...
\includegraphics{./icmr_summary_murdock1962.pdf}
...
\subfloat[PrototypeCMR]{\label{fig-cmr_repeffect}%
\begin{minipage}[c]{0.50\linewidth}

{\centering 

\includegraphics{./cmr_repeffect.pdf}
...
%
\subfloat[InstanceCMR]{\label{fig-icmr_repeffect}%
\begin{minipage}[c]{0.50\linewidth}

{\centering 

\includegraphics{./icmr_repeffect.pdf}
...
%
\subfloat[Data]{\label{fig-data_spacing}%
\begin{minipage}[t]{0.33\linewidth}
\raisebox{-\height}{
