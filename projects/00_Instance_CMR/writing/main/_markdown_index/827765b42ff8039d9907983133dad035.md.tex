...
{}<!-- #region -->\markdownRendererInterblockSeparator
...
{}This function decays over time, such that $\phi_se$ modulates the strength of primacy while $\phi_d$ modulates the rate of decay. <!-- #endregion -->\markdownRendererInterblockSeparator
