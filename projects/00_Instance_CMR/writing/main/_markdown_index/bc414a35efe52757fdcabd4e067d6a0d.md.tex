...
{}\begin{equation} \label{eq:1} M^{FC}_{pre(ij)} = \begin{cases} \begin{alignedat}{2} 1 - \gamma \text{, if } i=j \\markdownRendererInterblockSeparator
{}\markdownRendererInputVerbatim{./_markdown_index/225775d779a02f5aa6135c08e2976fa4.verbatim}\markdownRendererInterblockSeparator
...
{}The input to context is determined by:\relax